...
module.exports = {
    ...
    Mutation: {
        ...
        bookTrips: async (_, {launchIds}, {dataSources}) => {
            ...
            return {
                success: results && results.length === launchIds.length ? 'Trips booked successfully.' : `The following launches couldn't be booked: ${launchIds.filter(id => !results.includes(id))}`,
                launches,
            };
        },
